          ...
          {!loading && (
            <div className="w-full bg-white p-2">
              ...
              <p className="max-w-xl text-base font-medium text-gray-950 text-justify mb-2 indent-8">
                ...
                suka dengan dunia percodingan. Sedang menikmati indahnya
                kehidupan dengan cara menjalaninya bagai arus tapi sesekali
                melawan arus sih hehe. saya suka bulan november karena pada
                bulan tersebut bertepatan dengan bulan kelahiran ...
              </p>
              <p className="max-w-xl text-base font-medium text-gray-950 text-justify mb-2 indent-8">
                ...
                Muhammadiyah Cirebon dan alhamdulillah lulus walaupun tidak
                tepat waktu, setidaknya bisa lulus diwaktu yang tepat.
              </p>
            </div>
          )}
        </div>
